...
For a detailed description of how the model works, see our Overview, Design concepts, Details (ODD) model description available at: https://doi.org/10.1101/2021.01.21.21250240 and on the Lanzaslab github page (https://github.com/lanzaslab/droplet-ABM).
...
Farthing TS, & Lanzas C. (2021). Assessing the efficacy of interventions to control indoor SARS-Cov-2 transmission: an agent-based modeling approach. Preprint available at https://doi.org/10.1101/2021.01.21.21250240.
@#$#@#$#@
default
true
0
